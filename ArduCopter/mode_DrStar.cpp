...
bool Copter::Mode_DrStar::init(bool ignore_checks)
{
...
void Copter::Mode_DrStar::generate_path()
{
    float radius_cm=g2.star_raius_cm;
...
void Copter::Mode_DrStar::pos_control_start()
{
...
void Copter::Mode_DrStar::pos_control_run()
{
